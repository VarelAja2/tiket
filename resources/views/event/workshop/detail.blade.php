                    ...
                    <div class="w-64 md:w-full max-w-xs rounded-xl overflow-hidden shadow-2xl shadow-purple-900/30">
                        <div class="aspect-[2/3] bg-cover bg-center"
                            ...
                            <a href="{{ route('now-playing') }}"
                                class="absolute top-6 left-4 bg-purple-600 text-white text-md font-bold px-3 py-1 rounded-full">
                                Kembali
                            </a>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-1">
                ...
                <section id="ticket-section" class="bg-gray-800 rounded-xl p-6 sticky top-24">
                    ...
                    <a href="{{ route('booking.seats', ['event_id' => $event_id ?? 'competition-event']) }}"
                        class="block w-full py-3 bg-purple-600 text-white text-center font-bold rounded-lg hover:bg-yellow-700 transition-colors duration-300 mb-4">
                        Beli Tiket Sekarang
                    </a>
