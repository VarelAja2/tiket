                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">{{ old('description', $banner->description) }}</textarea>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="button_secondary_text" name="button_secondary_text"
                                value="{{ old('button_secondary_text', $banner->button_secondary_text) }}"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="url" id="button_secondary_url" name="button_secondary_url"
                                value="{{ old('button_secondary_url', $banner->button_secondary_url) }}"
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    <option value="secondary"
                                        {{ old('type', $banner->type) == 'secondary' ? 'selected' : '' }}>Sekunder</option>
                                </select>
                            </div>
