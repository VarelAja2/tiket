...
@section('content')
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea id="short_description" name="short_description" rows="2"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                        required>{{ old('short_description', $event->short_description) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="duration" name="duration"
                                        value="{{ old('duration', $event->duration) }}" placeholder="Contoh: 2h 30m"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="release_year" name="release_year"
                                        value="{{ old('release_year', $event->release_year) }}" min="1900"
                                        max="{{ date('Y') + 5 }}"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="age_rating" name="age_rating"
                                        ...
                                        <option value="SU"
                                            ...
                                            Umur)</option>
                                        <option value="13+"
                                            {{ old('age_rating', $event->age_rating) == '13+' ? 'selected' : '' }}>13+
                                        </option>
                                        <option value="17+"
                                            {{ old('age_rating', $event->age_rating) == '17+' ? 'selected' : '' }}>17+
                                        </option>
                                        <option value="21+"
                                            {{ old('age_rating', $event->age_rating) == '21+' ? 'selected' : '' }}>21+
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" id="discount_price" name="discount_price"
                                            value="{{ old('discount_price', $event->discount_price) }}" min="0"
                                            step="1000"
                                            class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" id="promo_code" name="promo_code"
                                        value="{{ old('promo_code', $event->promo_code) }}"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="promo_discount" name="promo_discount"
                                        value="{{ old('promo_discount', $event->promo_discount) }}" min="0"
                                        max="100"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                                </div>
                            </div>
                    ...
                    <div class="space-y-6">
                                ...
                                @foreach ($genres as $genre)
                                    <label class="flex items-center">
                                        <input type="checkbox" name="genres[]" value="{{ $genre->id }}"
                                            {{ in_array($genre->id, old('genres', $event->genres->pluck('id')->toArray())) ? 'checked' : '' }}
                        ...
                        <div>
                            ...
                            <input type="number" id="rating" name="rating"
                                value="{{ old('rating', $event->rating) }}" min="0" max="10"
                                step="0.1"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="total_seats" name="total_seats"
                                    value="{{ old('total_seats', $event->total_seats) }}" min="1"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="available_seats" name="available_seats"
                                    value="{{ old('available_seats', $event->available_seats) }}" min="0"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                                    required>
                            </div>
                        </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_coming_soon" value="1"
                                        {{ old('is_coming_soon', $event->is_coming_soon) ? 'checked' : '' }}
                                        class="rounded border-gray-300 text-red-600 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50">
    ...
    <script>
        ...
        document.getElementById('total_seats')?.addEventListener('change', function() {
            ...
            const currentAvailable = parseInt(availableSeats.value) || 0;
            const newTotal = parseInt(this.value) || 0;

            if (currentAvailable > newTotal) {
                availableSeats.value = newTotal;
            }
        });
    </script>
@endsection
